...
=========================================================================================================
*/
CREATE OR ALTER PROCEDURE staging.load_staging_archive_products AS
BEGIN
	-- Declare variables
	...
	BEGIN TRY
		...
		SET @layer = 'staging';
		SET @load_type = 'Full';
		SET @proc_name = 'load_staging_archive_products';
		SET @table_loaded = 'archive_products';
		SET @ingest_source = 'C:\Users\PC\Desktop\archive (1)\products.csv';
		SET @start_time = GETDATE();

		-- Delete data from table
		SET @sql = 'TRUNCATE TABLE staging.archive_products';
		EXEC(@sql);
