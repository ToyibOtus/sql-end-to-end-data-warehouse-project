...
=========================================================================================================
*/
CREATE OR ALTER PROCEDURE staging.load_staging_archive_sessions AS
BEGIN
	-- Declare variables
	...
	BEGIN TRY
		...
		SET @layer = 'staging';
		SET @load_type = 'Full';
		SET @proc_name = 'load_staging_archive_sessions';
		SET @table_loaded = 'archive_sessions';
		SET @ingest_source = 'C:\Users\PC\Desktop\archive (1)\sessions.csv';
		SET @start_time = GETDATE();

		-- Delete data from table
		SET @sql = 'TRUNCATE TABLE staging.archive_sessions';
		EXEC(@sql);
