...
=========================================================================================================
*/
CREATE OR ALTER PROCEDURE staging.load_staging_archive_customers @run_id UNIQUEIDENTIFIER = NULL AS
BEGIN
	...
	BEGIN TRY
		...
		SELECT @rows_loaded = COUNT(*) FROM staging.archive_customers;
