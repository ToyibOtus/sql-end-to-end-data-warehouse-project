...
=========================================================================================================
Script Purpose: 
	This script performs a full load on the staging table [staging.load_staging_archive_products]
...
Usage: EXEC staging.load_staging_archive_products;
...
=========================================================================================================
*/
CREATE OR ALTER PROCEDURE staging.load_staging_archive_products @run_id UNIQUEIDENTIFIER = NULL AS
BEGIN
	...
	@proc_name NVARCHAR(50) = 'load_staging_archive_products',
	@load_type NVARCHAR(50) = 'Full',
	@ingest_source NVARCHAR(250) = 'C:\Users\PC\Desktop\archive (1)\products.csv',
	@start_time DATETIME,
	@end_time DATETIME,
	@load_duration INT,
	...
	BEGIN TRY
		...
		TRUNCATE TABLE staging.archive_products;

		-- Load into table
		SET @sql = 'BULK INSERT staging.archive_products FROM ''' + @ingest_source + '''' +
		...
		SELECT @rows_loaded = COUNT(*) FROM staging.archive_products;
