...
=========================================================================================================
*/
CREATE OR ALTER PROCEDURE staging.load_staging_archive_order_items @batch_id UNIQUEIDENTIFIER = NULL AS
BEGIN
	...
	@proc_name NVARCHAR(50) = 'load_staging_archive_order_items',
	@load_type NVARCHAR(50) = 'Full',
	@ingest_source NVARCHAR(250) = 'C:\Users\PC\Desktop\archive (1)\order_items.csv',
	@start_time DATETIME,
	@end_time DATETIME,
	@load_duration INT,
	...
	BEGIN TRY
		...
		TRUNCATE TABLE staging.archive_order_items;
